...
// import { TableClickedAction, TableConfig } from '../../interfaces/table.interface';
...
//   @Output() selectedItems = new EventEmitter<string[]>();  @ViewChild('newContactModal', { static: false }) newContactModal?: ModalDirective;
